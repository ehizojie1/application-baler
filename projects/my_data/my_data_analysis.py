...
def analysis(project_name, data_path_before, data_path_after):
    ...
    variable = "recoPFJets_ak5PFJets__RECO.obj.mass_"
...
def plot_peak(project_path, before, after):
    ...
    for index in range(10000,100000,100):
        print(index)
        p0_c = index
        ...
        with PdfPages(project_path + "/plotting/analysis.pdf") as pdf:    
            ...
            optimizedParameters1, pcov1 = opt.curve_fit(fit, before_bin_centers, before_bin_counts, p0=[1,p0_c,1,1,1]);
            ...
            optimizedParameters2, pcov2 = opt.curve_fit(fit, after_bin_centers, after_bin_counts, p0=[1,p0_c,1,1,1]);
